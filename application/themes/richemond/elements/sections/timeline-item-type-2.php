...
<div class="timeline-item timeline-item_type-2">
    ...
    <div class="layers">
        ...
        <div class="layer">
            <div class="grid-x grid-margin-x flex-container align-justify align-bottom">
            ...
            <div class="user-editable-content user-editable-content_no-p-margins">
                <?php
                $a = new Area($handle . '_image_' . $entryID);
                $a->setAreaDisplayName('Middle Image ' . $entryShortTitle);
                $a->setCustomTemplate('image', 'templates/img_dragable_false');
                $a->display($c);
                ?>
            </div>
            <div class="grid-x grid-margin-x flex-container align-justify align-top">
                <div class="medium-5 cell">
                    <div class="user-editable-content user-editable-content_no-p-margins">
                        <?php
                        $a = new Area($handle . '_left_col_1_' . $entryID);
                        $a->setAreaDisplayName('Left Column ' . $entryShortTitle);
                        $a->setCustomTemplate('page_title', 'templates/history_text_block_title');
                        $a->display($c);
                        ?>
                ...
                <div class="medium-5 cell">
                    <div class="user-editable-content user-editable-content_no-p-margins">
                        <?php
                        $a = new Area($handle . '_right_col_2_' . $entryID);
                        $a->setAreaDisplayName('Right Column ' . $entryShortTitle);
                        $a->setCustomTemplate('page_title', 'templates/history_text_block_title');
                        $a->display($c);
                        ?>
